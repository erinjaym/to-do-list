...
import {
  testStorage,
  checkForDailyStorage,
  checkForProjectsStorage,
} from "./storage";
...
const navBarModule = (() => {
  ...
  const displayActiveProjects = () => {
    ...
    for (
      ...
      currentProject <= projectsToDisplay.length - 1;
      currentProject++
    ) {
...
// initial call to make the navbar appear
...
const projectMenuModule = (() => {
  const createProjectWindow = () => {
    ...
    submitButton.addEventListener("click", () => {
      ...
      // for posible future details addition
  ...
  const createDailyTaskWindow = () => {
    ...
    submitButton.addEventListener("click", () => {
      ...
      if (newName == "") {
        ...
        let newDailyTask = makeDailyItem(
          newName,
          newDetail,
          newPriority,
          newStatus
  ...
  const editDailyTaskWindow = () => {
    ...
    function setCompleted() {
      //  checks appropriate radio button based saved task value
  ...
  const createProjectTaskWindow = () => {
    ...
    submitButton.addEventListener("click", () => {
      ...
      if (newName == "") {
        ...
        let newProjectTask = makeProjectItem(
          newName,
          newDetail,
          newPriority,
          newCompleted,
  ...
  const projectHeadingDisplay = () => {
    if (selectedProject == "Daily Tasks") {
      // populate daily project information in display
      ...
      (function createDailyTaskButtons() {
      ...
      if (toggledProjectName == "nofutureprojects") {
        // display default daily
  ...
  const taskListDisplay = () => {
        ...
        (function addTaskListeners() {
          tableContent.addEventListener("click", function selectTask() { // add task selection event listener
            ...
            if (selectedTask != taskName) {
              if (document.getElementById(selectedTask)) {
                // if found
            ...
            } // if same make sure selection is made
            else {
              tableRow.className = "tr-selected";
              selectedTask = taskName;
            }
    ...
    } //selectedProject != "Daily Tasks" for project task display
    else {
      let tableHeader = document.createElement("tr");
      tableHeader.className = "table-header";
      tableHeader.id = "table-headers";
  ...
  const clearDisplay = () =>
    // refreshes projects and tasks bar ... not an more
    {
...
function displayProject() {
  // to add exception for when there are no projects left to delete that will just stay displaying daily
